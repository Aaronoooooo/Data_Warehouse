package com.apache.gmall.dw.publisher.controller;

import com.alibaba.fastjson.JSON;
import com.apache.gmall.dw.publisher.bean.Option;
import com.apache.gmall.dw.publisher.bean.Stat;
import com.apache.gmall.dw.publisher.service.PublishService;
...
public class PublishController {
    ...
    public String getRealtimeHour(@RequestParam("id") String id, @RequestParam("date") String date) {
        if ("dau".equals(id)) {
            ...
            Double totalamountHoursTodayMap = publishService.getNewOrderTotalAmount(date);
            //今天变昨天
            Date today = null;
            try {
                today = new SimpleDateFormat("yyyy-MM-dd").parse(date);
    ...
    public String getSaleDetail(HttpServletRequest request) {
        ...
        //求男女比例
        HashMap genderMap = (HashMap) saleGenderMap.get("age");
        ...
        HashMap ageMap = (HashMap) saleAgeMap.get("age");
        long age20Count = 0L;
        long age2030Count = 0L;
        double age30Count = 0L;
        ...
        ageOptions.add(new Option("20到30岁", age2030Ratio));
