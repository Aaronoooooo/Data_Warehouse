package com.apache.gmall.dw.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.apache.gmall.dw.mock.sender.LogUploader;
import com.apache.gmall.dw.mock.util.*;
...
public class JsonMocker {
    ...
    RandomOpt[] quitOpts = {new RandomOpt(true, 80), new RandomOpt(false, 20)};
    ...
    String initStartupLog() {
     ...
     `ch` string COMMENT '城市'
     */


        String mid = "mid_" + RandomNum.getRandInt(100, 500);
